...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/dist/css/jquery-confirm.css') }}">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
            ...
            <div class="auth-box border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="adminFrm" data-action="#" method="post">
                        @csrf
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control form-control-lg" placeholder="Email"
                                        aria-label="email" aria-describedby="basic-addon1" id="exampleInputEmail1"
                                        name="email" />
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    <input type="password" class="form-control form-control-lg" placeholder="Password"
                                        aria-label="Password" aria-describedby="basic-addon1" id="exampleInputPassword1"
                                        name="password" />
                                </div>
                            </div>
                        </div>
