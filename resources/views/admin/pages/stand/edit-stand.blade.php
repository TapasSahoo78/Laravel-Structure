            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" id="adminFrm" data-action="" method="post">
                            @csrf
                            <div class="card-body">
                                <h4 class="card-title">Edit Stand</h4>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="stand_name" name="stand_name"
                                            placeholder="Stand Name Here" value="{{ $stand->stand_name }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="address" name="address"
                                            placeholder="Address Here" value="{{ $stand->address }}" />
                                    </div>
                                </div>
                                <div class="form-group row" id="longtitudeArea">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="longitude" name="longitude"
                                            placeholder="Longitude Here" value="{{ $stand->longitude }}" />
                                    </div>
                                </div>
                                <div class="form-group row" id="latitudeArea">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="latitude" name="latitude"
                                            placeholder="Latitude Here" value="{{ $stand->latitude }}" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="stand_manager" class="col-sm-3 text-end control-label col-form-label">
                                        Stand Manager :</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="stand_manager" id="stand_manager"
                                            class="typeahead form-control" placeholder="Choose Manager"
                                            value="{{ !empty($stand->standManagerList) ? $stand->standManagerList[0]->getStandManager?->manager_name : '' }}" />
                                    </div>
                                </div>
